...
const data = [
  { id: 1, title: "Kesehatan Mental", description: desc, image: card1, link: "/details/1" },
  { id: 2, title: "Risiko Kanker Paru", description: desc, image: card1, link: "/details/1" },
];
...
export default function DiseaseRiskDetection() {
  ...
  return (
    <>
      <NavBar selectedNav="drp" itemsBread={[{ title: 'Home' }, { title: 'Deteksi Risiko Penyakit' }]}>
        <Row gutter={[16, 16]}>
          {data.map((item) => {
            return (
